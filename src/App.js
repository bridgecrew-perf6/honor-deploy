  ...
  return (
    <BrowserRouter>
      <div className='App'>
        ...
        <NavbarCopy langTitle={langTitle} english={english} russian={russian} uzbek={uzbek} change1={change1} change2={change2} change3={change3} />
        <Switch>
            <Route exact path="/">
            <HeaderInput />
            <BestProducts dataProducts={dataProducts} dataMenu={dataMenu} dataTip={dataTip} showHandleBuy={showHandleBuy} />
            {/* <Category /> */}
            <Sofa />
            <Client />
            <SliderBox />
